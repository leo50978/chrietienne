document.addEventListener("DOMContentLoaded", () => {
    ...
    const currentPage = (() => {
        ...
        return (fileName || "celi.html").toLowerCase();
    })();

    const activePageMap = {
        "celi-actualites.html": "celi-formations.html",
        "celi-partenaires.html": "celi-contact.html",
        "celi-inscription.html": "celi-formations.html"
    };
    ...
    const isActiveLink = (href) => {
        ...
        if (navPage === "celi.html") {
            return href === "celi.html" || href === "#accueil";
        }
